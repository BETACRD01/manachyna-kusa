...
class _ChatListScreenState extends State<ChatListScreen> {
        ...
        builder: (context, chatProvider, _) {
          return KeyedSubtree(
            ...
            child: StreamBuilder<List<Chat>>(
              stream: chatProvider.getUserChats(currentUser.uid),
  ...
  Future<void> _markAsRead(
    ...
    final chatProvider = context.read<ChatProvider>();
    try {
      await chatProvider.markChatAsRead(chat.id, currentUserId);
  ...
  Future<void> _deleteChat(
    ...
    try {
      // Delete the chat
      await chatProvider.deleteChat(chat.id, requesterId: currentUserId);
