...
class _ProviderSelectionService {
  ...
  Future<List<Map<String, dynamic>>> getProviders(String category) async {
    try {
      AppLogger.d('Fetching providers for category: $category from Django');
      final response = await _apiService.get('providers/?category=$category');
      return List<Map<String, dynamic>>.from(response);
    } catch (e) {
      AppLogger.e('Error fetching providers from Django: $e');
      return [];
    }
  }
  ...
  List<Map<String, dynamic>> filterProviders(
    ...
    AppLogger.d('Filtering providers for category: $category');
  ...
  List<Map<String, dynamic>> sortProvidersByRating(
    ...
    AppLogger.d('Sorting providers by rating');
...
class _ProviderListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<Map<String, dynamic>>>(
      future: service.getProviders(category),
            ...
            ElevatedButton.icon(
              onPressed: () {
                try {
                  ...
                  AppLogger.e('🚨 Error de navegación: $e');
                }
                onCancel();
              },
